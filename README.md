...
For tensorflow 2.0 version you can switch the branch to `tensorflow2` to run the code for `HBAM` and `MaLSTM`. We also add `tensorboard` sentence embedding visualization in branch `tensorflow2`.
